...
$lang = array_merge($lang, array(
	'ADMIN_SIG_PREVIEW'	=> 'پێشبینی ئیمزا',
	'AT_LEAST_ONE_FOUNDER'	=> 'تۆ ناتوانی ئەم تاکە بەڕیوەبەری گشتیە بکەی بە ئەندامێکی سادە . دەبێت بە لایەنی کەمەوە یەکێک هەبێت بۆ ئەم بەشە . ئەگەر دەتەوێت دۆخی ئەم بەڕێوەبەری گشتیە بگۆڕی دەتوانی ئەندامێک زیاد بکەی بۆ بەڕێوەبەری گشتی تا بتوانی دۆخی ئەم بەڕێوەبەریە گشتیە بگۆڕیت.',
	'BAN_ALREADY_ENTERED'	=> 'The ban had been previously entered successfully. The ban list has not been updated.',
	'BAN_SUCCESSFUL'	=> 'بان کردن بەسەرکەوتووی ئەنجام درا.',
	...
	'CANNOT_BAN_YOURSELF'	=> 'تۆ ماتوانی خۆت بان بکەی.',
	...
	'CANNOT_DEACTIVATE_YOURSELF'	=> 'تۆ ناتوانی کۆنتۆی خۆت ناچالاک بکەیت.',
	...
	'GROUP_DEFAULT'	=> 'گرووپی بنەڕەتی بۆ ئەندامان دروست بکە',
	'GROUP_DELETE'	=> 'ئەندام لە گرووپ بسڕەوە',
	...
	'NO_SPECIAL_RANK'	=> 'هیچ پلەیەکی تایبەت دیاریک نەکراوە',
	'NO_WARNINGS'			=> 'هیچ ئاگاداریەک نیە.',
	...
	'USER_ADMIN_BAN_USER'	=> 'بانکردن بە هۆی ناوی بەکارهێنەر',
	...
	'USER_WARNING_LOG_DELETED'		=> 'هیچ زانیاریەک بوونی نیە ، لەوانەیە لۆگی چونەژورەوەکان سرابێتەوە.',
